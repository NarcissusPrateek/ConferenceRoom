...
class AddBuildingViewModelTest {
    ...
    val mStatusEmptyBNameValue = MutableLiveData<Int>()
    val mStatusEmptyPlaceValue = MutableLiveData<Int>()
    ...
    fun setUp(){
        ...
        `when`(mAddBuildingViewModel.addBuildingDetails(mAddBuildingEmptyBuildingName)).thenReturn(mStatusEmptyBNameValue)
